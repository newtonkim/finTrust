        ...
        <div class="px-8 py-8">
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input
                  ...
                  autocomplete="name"
                  required
                  :class="`block w-full pl-10 pr-3 py-3 border ${form.errors.name ? 'border-red-300' : 'border-gray-300'} rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200`"
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input
                  ...
                  autocomplete="new-password"
                  required
                  :class="`block w-full pl-10 pr-3 py-3 border ${form.errors.password_confirmation ? 'border-red-300' : 'border-gray-300'} rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200`"
                  placeholder="••••••••"
          ...
          <div class="mt-6 text-center">
            <p class="text-sm text-gray-600">
              ...
              <Link href="/login" class="font-medium text-indigo-600 hover:text-indigo-500 transition-colors duration-200">
                Sign in
              </Link>
            </p>
          </div>
